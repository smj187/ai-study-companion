...
export const VoiceRecorder: React.FC<Props> = () => {
  ...
  const onCheckAnswer = async () => {
    ...
    const question = appQuestions.filter(appQuestion => appQuestion.id !== currentlyActiveQuestionId)[0] // TODO beautify
    params.append("input_answer", response.text)
    params.append("ground_truth1", question.assemblyAnswer)
    params.append("ground_truth2", question.chatGptAnswer)
      ...
      <div>
        ...
        <div className="m-9 bg-white rounded relative p-3 flex w-full max-w-md justify-between mx-auto">
          ...
          <div className="h-12 w-12">
            {isRecording && (
              <button
                onClick={stop} className="bg-white rounded-md w-full h-full grid place-content-center cursor-pointer shadow-sm">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
              ...
              <span className="text-sm uppercase pr-2">Check Answer</span>
                ...
                >
                  ...
                  >
                    ...
                    <svg aria-hidden="true" className="mr-2 w-4 h-4 text-gray-200 animate-spin dark:text-gray-600 fill-rose-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
